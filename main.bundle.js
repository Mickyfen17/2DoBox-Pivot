...
/***/ function(module, exports) {
	...
	var updateStoredQuality = exports.updateStoredQuality = function updateStoredQuality(voteButton, newQuality) {
	...
	var editIdeas = exports.editIdeas = function editIdeas(item, content) {
	...
	var enableSaveBtn = exports.enableSaveBtn = function enableSaveBtn() {
	  var title = $(".title").val();
	  var idea = $(".idea").val();
	  var saveBtn = $(".save");
...
/***/ function(module, exports) {
	...
	$(".search-input").on("keyup", function () {
	  ...
	  ideas.each(function (i, idea) {
	    var ideaText = $(idea).text().toLowerCase();
	    var matched = ideaText.includes(searchText);
	    $(idea).toggle(matched);
	  });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	$(".save").on("click", function () {
	  ...
	  (0, _app.clearInputs)();
	  (0, _app.enableSaveBtn)();
	});

	//keyup event listener for title and idea inputs
	$(".title, .idea").on("keyup", _app.enableSaveBtn);
	...
	$(".entries").on("click", ".upvote", function () {
	  var currentQuality = $(this).siblings(".quality");
	  currentQuality.text() === "swill" ? currentQuality.text("plausible") : currentQuality.text("genius");
	  (0, _app.updateStoredQuality)(this, currentQuality);
	});
	...
	//event listener to edit title and update title value in local storage
	$(".entries").on("blur", "h5", function () {
	  (0, _app.editIdeas)(this, "title");
	});

	//event listener to edit body and update body value in local storage
	$(".entries").on("blur", "p", function () {
	  (0, _app.editIdeas)(this, "body");
	});
