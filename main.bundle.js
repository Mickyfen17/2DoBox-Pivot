...
/***/ function(module, exports, __webpack_require__) {
	...
	var _styles = __webpack_require__(108);

	var _styles2 = _interopRequireDefault(_styles);

	var _filterButtons = __webpack_require__(118);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.markAsComplete = exports.editTodoInLS = exports.updateStoredQuality = exports.deleteFromLS = exports.showAllCompleted = exports.retrieveTodos = exports.grabValues = undefined;

	var _display = __webpack_require__(102);

	var _helpers = __webpack_require__(104);

	var _constructor = __webpack_require__(105);

	// library object to be passed into local storage
	var libraryObj = {};

	// grabs input value and assigns to new todo object
	var grabValues = exports.grabValues = function grabValues(uniqueID) {
	  var title = $(".title").val();
	  var task = $(".task").val();
	  var newTodo = new _constructor.NewTodo({ id: uniqueID, title: title, body: task });
	  stringObj(uniqueID, newTodo);
	};

	// function to stringify new object and save to local storage
	var stringObj = function stringObj(id, todoObj) {
	  libraryObj[id] = todoObj;
	  var stringObj = JSON.stringify(libraryObj);
	  localStorage.setItem("2Do", stringObj);
	  retrieveTodos();
	};

	// removes all previous todos and then loops through local storage and parses the data
	var retrieveTodos = exports.retrieveTodos = function retrieveTodos() {
	  $(".todo-card").remove();
	  var completed = 0;
	  libraryObj = JSON.parse(localStorage["2Do"]);
	  for (var key in libraryObj) {
	    var todo = new _constructor.NewTodo(libraryObj[key]);
	    todo.isComplete === "" ? (0, _display.displayTodo)(todo) : completed++;
	  }
	  (0, _helpers.checkForCompletedTodos)(completed);
	};

	// displays all todos with the class of completed after click on show all completed
	var showAllCompleted = exports.showAllCompleted = function showAllCompleted() {
	  libraryObj = JSON.parse(localStorage["2Do"]);
	  for (var key in libraryObj) {
	    var todo = new _constructor.NewTodo(libraryObj[key]);
	    if (todo.isComplete !== "") {
	      (0, _display.displayTodo)(todo);
	    }
	  }
	};

	// deletes todo from local storage
	var deleteFromLS = exports.deleteFromLS = function deleteFromLS(id) {
	  libraryObj = JSON.parse(localStorage["2Do"]);
	...
	var updateStoredQuality = exports.updateStoredQuality = function updateStoredQuality(voteButton, id) {
	  libraryObj = JSON.parse(localStorage.getItem("2Do"));
	  var toEditTodo = new _constructor.NewTodo(libraryObj[id]);
	  (0, _helpers.qualityRange)(voteButton, toEditTodo);
	  var quality = toEditTodo.quality,
	      qualityCount = toEditTodo.qualityCount;

	  $(voteButton).siblings(".quality").text(quality);
	  toEditTodo.qualityCount = (0, _helpers.ifZero)(qualityCount);
	  stringifyLib(toEditTodo, id);
	};

	// updates edited todo in local storage
	var editTodoInLS = exports.editTodoInLS = function editTodoInLS(content, key, id) {
	  var toEditTodo = parseLib(id);
	  toEditTodo[key] = content.innerText;
	  stringifyLib(toEditTodo, id);
	};

	// updates the todo in local storage as to whether its complete or not
	var markAsComplete = exports.markAsComplete = function markAsComplete(id) {
	  var toEditTodo = parseLib(id);
	  libraryObj = JSON.parse(localStorage["2Do"]);
	...
	var parseLib = function parseLib(id) {
	  libraryObj = JSON.parse(localStorage["2Do"]);
	  return libraryObj[id];
	};

	// stringify lib helper function
	var stringifyLib = function stringifyLib(todo, id) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.displayTodo = undefined;

	var _closures = __webpack_require__(103);

	// create new buttons
	var createDeleteBtn = function createDeleteBtn() {
	  return $("<button aria-label='delete' class='delete'></button>");
	};
	var createUpBtn = function createUpBtn() {
	  return $("<button aria-label='up vote' class='upvote'></button>");
	};
	var createDownBtn = function createDownBtn() {
	  return $("<button aria-label='down vote' class='downvote'></button>");
	};

	// create basic to card to be preneded with button nodes
	var creatCard = function creatCard(newTodoContent) {
	  var id = newTodoContent.id,
	      quality = newTodoContent.quality,
	      isComplete = newTodoContent.isComplete;
	...
	var displayTodo = exports.displayTodo = function displayTodo(newTodoContent) {
	  var id = newTodoContent.id,
	      title = newTodoContent.title,
	      body = newTodoContent.body;

	  var deleteBtn = createDeleteBtn();
	  var upBtn = createUpBtn();
	  var downBtn = createDownBtn();
	  var todoCard = creatCard(newTodoContent);
	  var titleNode = $("<h5 aria-label='todo card title' class='todo-title edit' contenteditable>" + title + "</h5>");
	  var bodyNode = $("<p aria-label='todo card body' class='todo-body edit' contenteditable>" + body + "</p>");
	  var completeBtnNode = $("<button class='complete'>Completed</button>");
	  $(".entries").prepend(todoCard);
	  $("#" + newTodoContent.id).prepend(deleteBtn, titleNode, bodyNode, upBtn, downBtn, completeBtnNode);
	  (0, _closures.deleteTodo)(deleteBtn, todoCard, id);
	  (0, _closures.voteButtons)(upBtn, downBtn, id);
	  (0, _closures.editTodos)(titleNode, bodyNode, id);
	  (0, _closures.completeTodo)(completeBtnNode, id);
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.completeTodo = exports.deleteTodo = exports.voteButtons = exports.editTodos = undefined;

	var _app = __webpack_require__(1);

	// closure function to edit content of title and body
	var editTodos = exports.editTodos = function editTodos(title, body, id) {
	  title.on("blur", function () {
	    (0, _app.editTodoInLS)(this, "title", id);
	  });
	  body.on("blur", function () {
	    (0, _app.editTodoInLS)(this, "body", id);
	  });
	};

	// closure to add click event to up & down vote button
	var voteButtons = exports.voteButtons = function voteButtons(upBtn, downBtn, id) {
	  upBtn.on("click", function () {
	    (0, _app.updateStoredQuality)(this, id);
	  });
	...
	var deleteTodo = exports.deleteTodo = function deleteTodo(button, todo, id) {
	  button.on("click", function () {
	    (0, _app.deleteFromLS)(id);
	    todo.remove();
	  });
	};

	// closure to toggle completed class to todo card
	var completeTodo = exports.completeTodo = function completeTodo(button, id) {
	  button.on("click", function () {
	    (0, _app.markAsComplete)(id);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var enableSaveBtn = exports.enableSaveBtn = function enableSaveBtn(charsCount) {
	  var title = $(".title").val();
	  var task = $(".task").val();
	  var saveBtn = $(".save");
	  if (charsCount < 0) {
	...
	var charCounter = exports.charCounter = function charCounter() {
	  var inputLength = $(".task").val().length;
	  var chars = 120 - inputLength;
	  enableSaveBtn(chars);
	  $("#char-count").text(chars);
	};

	// helper function to enable/disable show all completed button on page reload
	var checkForCompletedTodos = exports.checkForCompletedTodos = function checkForCompletedTodos(number) {
	...
	var qualityRange = exports.qualityRange = function qualityRange(button, toDo) {
	...
	var ifZero = exports.ifZero = function ifZero(number) {
...
/***/ function(module, exports) {
	...
	var NewTodo = exports.NewTodo = function () {
	  function NewTodo(_ref) {
	    var id = _ref.id,
	        title = _ref.title,
	        body = _ref.body,
	        qualityCount = _ref.qualityCount,
	  ...
	  _createClass(NewTodo, [{
	    key: "upVoteQuality",
	    value: function upVoteQuality() {
	      this.qualityCount++;
	      this.quality = this.qualityArr[this.qualityCount];
	    }
	  }, {
	    key: "downVoteQuality",
	    value: function downVoteQuality() {
	      this.qualityCount--;
	      this.quality = this.qualityArr[this.qualityCount];
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	$(".search-input").on("keyup", function () {
	  ...
	  todos.each(function (i, todo) {
	    var todoText = $(todo).children(".edit").text().toLowerCase();
	    var matched = todoText.includes(searchText);
	    $(todo).toggle(matched);
	  });
	});
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	$(".save").on("click", function () {
	  ...
	  (0, _app.grabValues)(uniqueID);
	  (0, _helpers.clearInputs)();
	  (0, _helpers.charCounter)();
	});

	// keyup event listener for title input
	$(".title").on("keyup", _helpers.enableSaveBtn);

	// keyup event listener for todo inputs
	$(".task").on("keyup", _helpers.charCounter);

	// on load retrieve all items from local storage
	$(document).ready(_app.retrieveTodos);

	// event listener for show button
	$(".show").on("click", function () {
	  (0, _app.showAllCompleted)();
...
/***/ function(module, exports) {
	...
	module.exports = "\"data:image/svg+xml;charset=utf8,%3C?xml version='1.0' encoding='utf-8'?%3E %3C!-- Generator: Adobe Illustrator 20.0.0, SVG Export Plug-In . SVG Version: 6.00 Build 0) --%3E %3Csvg version='1.1' id='Layer_1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' viewBox='0 0 20 20' style='enable-background:new 0 0 20 20;' xml:space='preserve'%3E %3Cstyle type='text/css'%3E .st0%7Bfill:%23696969;%7D .st1%7Bfill:%23FFFFFF;%7D %3C/style%3E %3Cg%3E %3Cg%3E %3Cellipse transform='matrix(0.7071 -0.7071 0.7071 0.7071 -4.1604 9.9558)' class='st0' cx='9.9' cy='10' rx='8.7' ry='8.7'/%3E %3Cg%3E %3Crect x='5.7' y='9.5' transform='matrix(0.7071 -0.7071 0.7071 0.7071 -4.1604 9.9559)' class='st1' width='8.5' height='1'/%3E %3Crect x='9.4' y='5.7' transform='matrix(0.7071 -0.7071 0.7071 0.7071 -4.1604 9.9559)' class='st1' width='1' height='8.5'/%3E %3C/g%3E %3C/g%3E %3C/g%3E %3C/svg%3E\""
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toggleToDoDisplay = function toggleToDoDisplay(importance) {
	  $(".todo-card").each(function (index, card) {
	    var cardQuality = $(card).find(".quality").text().toLowerCase();
